...
; 0000 002F DDRA=(1<<DDA7) | (1<<DDA6) | (1<<DDA5) | (1<<DDA4) | (1<<DDA3) | (1<<DDA2) | (1<<DDA1) | (1<<DDA0);
	LDI  R30,LOW(255)
	OUT  0x1A,R30
...
; 0000 003B DDRC=(0<<DDC7) | (0<<DDC6) | (0<<DDC5) | (0<<DDC4) | (1<<DDC3) | (1<<DDC2) | (1<<DDC1) | (1<<DDC0);
	LDI  R30,LOW(15)
	OUT  0x14,R30
; 0000 003C // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=0 Bit2=0 Bit1=0 Bit0=0
...
; 0000 005A TCCR1A=(0<<COM1A1) | (0<<COM1A0) | (0<<COM1B1) | (0<<COM1B0) | (0<<WGM11) | (0<<WGM10);
	OUT  0x2F,R30
; 0000 005B TCCR1B=(0<<ICNC1) | (0<<ICES1) | (0<<WGM13) | (0<<WGM12) | (0<<CS12) | (0<<CS11) | (0<<CS10);
	OUT  0x2E,R30
...
; 0000 006A ASSR=0<<AS2;
	OUT  0x22,R30
; 0000 006B TCCR2=(0<<WGM20) | (0<<COM21) | (0<<COM20) | (0<<WGM21) | (0<<CS22) | (0<<CS21) | (0<<CS20);
	OUT  0x25,R30
...
; 0000 0070 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<OCIE0) | (0<<TOIE0);
	OUT  0x39,R30
; 0000 0071 
...
; 0000 0076 MCUCR=(0<<ISC11) | (0<<ISC10) | (0<<ISC01) | (0<<ISC00);
	OUT  0x35,R30
; 0000 0077 MCUCSR=(0<<ISC2);
	OUT  0x34,R30
; 0000 0078 
; 0000 0079 // USART initialization
; 0000 007A // USART disabled
; 0000 007B UCSRB=(0<<RXCIE) | (0<<TXCIE) | (0<<UDRIE) | (0<<RXEN) | (0<<TXEN) | (0<<UCSZ2) | (0<<RXB8) | (0<<TXB8);
	OUT  0xA,R30
; 0000 007C 
...
; 0000 00A2         LED4 = 0;
	CBI  0x15,3
; 0000 00A3         PORTB = cont;
	OUT  0x18,R4
; 0000 00A4         if (cont >= 2 && cont <= 5) {//4->32 M2
	LDI  R30,LOW(2)
	CP   R4,R30
	BRLO _0x15
	LDI  R30,LOW(5)
...
; 0000 00A6             LED2 = 1;
	SBI  0x15,1
; 0000 00A7         } else if (cont >= 6 && cont <= 10) {//8->16  M2
	RJMP _0x1B
_0x14:
	LDI  R30,LOW(6)
	CP   R4,R30
...
; 0000 00A9             LED2 = 0;
	CBI  0x15,1
; 0000 00AA         } else if (cont >= 13 && cont <= 19) {//16->8 M1
	RJMP _0x23
_0x1C:
	LDI  R30,LOW(13)
	CP   R4,R30
...
; 0000 00AC             LED4 = 1;
	SBI  0x15,3
; 0000 00AD         } else if (cont >= 28 && cont <= 36) { //32->4 M1
	RJMP _0x2B
_0x24:
	LDI  R30,LOW(28)
	CP   R4,R30
