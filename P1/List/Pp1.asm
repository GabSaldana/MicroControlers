...
; 0000 0028 // State7=P State6=P State5=P State4=P State3=P State2=P State1=P State0=P
...
; 0000 0034 // State7=0 State6=0 State5=0 State4=0 State3=0 State2=0 State1=0 State0=0
...
; 0000 0040 // Clock value: Timer1 Stopped
; 0000 0041 // Mode: Normal top=0xFFFF
; 0000 0042 // OC1A output: Discon.
; 0000 0043 // OC1B output: Discon.
...
; 0000 0064 TIMSK=0x00;
	OUT  0x39,R30
; 0000 0065 
; 0000 0066 // UART initialization
; 0000 0067 // UART disabled
; 0000 0068 
